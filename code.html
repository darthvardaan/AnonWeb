...
<div class="mycard mdl-card mdl-shadow--2dp"><center><div class="mdl-card__supporting-text">
    ...
    <p>
	This website uses Whatsapp public API. Send Whatsapp messages without saving the contact, choose among the web version or the app to open chat.</br> A project as simple as possible.</br>
